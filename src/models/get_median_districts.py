    ...
    for i in range(16):
        for j in years:
            ...
            if meds2['label'].iloc[0] == 1:
                ...
                meds2["cluster_desc"] = 'School districts with a single school, generally with less than 500 students.* Academic performance trends low (24.5 - 47.5 out of 100).**'
                ...
                meds2["cluster_category"] = 'Single'
                meds2["cluster_desc"] = 'School districts with a single school, generally with less than 500 students.* Academic performance trends high (64.5 - 82.0 out of 100).**'
            elif meds2['label'].iloc[0] == 4:
                meds2["cluster_name"] = 'Single Very High Enrollment School Districts'
                meds2["cluster_category"] = 'Single'
                meds2["cluster_desc"] = 'School districts with a single school, generally with 5,000+ students. Academic performance trends low (31.5 - 58.5 out of 100).**'

            elif meds2['label'].iloc[0] == 5:
                meds2["cluster_name"] = 'Small Lower Performance Districts'
                meds2["cluster_category"] = 'Small'
                meds2["cluster_desc"] = 'Small school districts (2-3 schools), generally with less than 725 students.* Academic performance trends low (33.0 - 50.0 out of 100).**'
            elif meds2['label'].iloc[0] == 6:
                meds2["cluster_name"] = 'Small Higher Performance Districts'
                meds2["cluster_category"] = 'Small'
                meds2["cluster_desc"] = 'Small school districts (2-3 schools), generally with less 725 students.* Academic performance trends high (69.5 - 84.0 out of 100).**'
            elif meds2['label'].iloc[0] == 7:
                meds2["cluster_name"] = 'Small High Enrollment Districts'
                meds2["cluster_category"] = 'Small'
                meds2["cluster_desc"] = 'Small school districts (2-3 schools), generally with 1,000+ students.* Academic performance varies widely (54.0 - 78.5 out of 100 with numerous outliers).**'
            elif meds2['label'].iloc[0] == 8:
                meds2["cluster_name"] = 'Small Very High Enrollment Districts'
                meds2["cluster_category"] = 'Small'
                meds2["cluster_desc"] = 'Small school districts (2-3 schools), generally with 2,000+ students.* Academic performance varies widely (39.0 - 79.4 out of 100).**'
                ...
                meds2["cluster_category"] = 'Medium'
                meds2["cluster_desc"] = 'Mid-sized school districts (4-10 schools), generally with 3,000+ students.* Academic performance varies widely (60.0 - 81.5 out of 100 with numerous outliers).**'
                ...
                meds2["cluster_category"] = 'Medium'
                meds2["cluster_desc"] = 'Mid-sized school districts (4-10 schools), generally with 5,000+ students.* Academic performance varies widely (47.0 - 78.0 out of 100).**'

            elif meds2['label'].iloc[0] == 13:
                meds2["cluster_name"] = 'Large Higher Performance Districts'
                meds2["cluster_category"] = 'Large'
                meds2["cluster_desc"] = 'Large school districts (11+ schools), generally with less than 20,000 students.* Academic performance trends high (67.0 - 83.0 out of 100).**'
            elif meds2['label'].iloc[0] == 14:
                meds2["cluster_name"] = 'Large Very High Enrollment Districts'
                meds2["cluster_category"] = 'Large'
                meds2["cluster_desc"] = 'Large school districts (11+ schools), generally with 350,000+ students.* Academic performance trends low (39.8 - 57.5 out of 100).**'
                ...
                meds2["cluster_name"] = 'Large Lower Performance School Districts'
                meds2["cluster_category"] = 'Large'
                meds2["cluster_desc"] = 'Large school districts (11+ schools), generally with less than 20,000 students.* Academic performance trends low (36.0 - 52.0 out of 100 with numerous outliers).**'
            # print(df2)
